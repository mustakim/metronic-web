...
var CustomerEffects = /** @class */ (function () {
    ...
    __decorate([
        effects_1.Effect()
    ], CustomerEffects.prototype, "loadCustomersPage$");
    __decorate([
        effects_1.Effect()
    ], CustomerEffects.prototype, "deleteCustomer$");
    __decorate([
        effects_1.Effect()
    ], CustomerEffects.prototype, "deleteCustomers$");
    __decorate([
        effects_1.Effect()
    ], CustomerEffects.prototype, "updateCustomer$");
    __decorate([
        effects_1.Effect()
    ], CustomerEffects.prototype, "updateCustomersStatus$");
    __decorate([
        effects_1.Effect()
    ], CustomerEffects.prototype, "createCustomer$");
