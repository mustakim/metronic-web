...
var ProductEffects = /** @class */ (function () {
    ...
    __decorate([
        effects_1.Effect()
    ], ProductEffects.prototype, "loadProductsPage$");
    __decorate([
        effects_1.Effect()
    ], ProductEffects.prototype, "deleteProduct$");
    __decorate([
        effects_1.Effect()
    ], ProductEffects.prototype, "deleteProducts$");
    __decorate([
        effects_1.Effect()
    ], ProductEffects.prototype, "updateProductsStatus$");
    __decorate([
        effects_1.Effect()
    ], ProductEffects.prototype, "updateProduct$");
    __decorate([
        effects_1.Effect()
    ], ProductEffects.prototype, "createProduct$");
