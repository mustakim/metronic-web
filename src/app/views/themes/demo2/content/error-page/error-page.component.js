...
var ErrorPageComponent = /** @class */ (function () {
    ...
    __decorate([
        core_1.Input()
    ], ErrorPageComponent.prototype, "type");
    __decorate([
        core_1.Input()
    ], ErrorPageComponent.prototype, "image");
    __decorate([
        core_1.Input()
    ], ErrorPageComponent.prototype, "code");
    __decorate([
        core_1.Input()
    ], ErrorPageComponent.prototype, "title");
    __decorate([
        core_1.Input()
    ], ErrorPageComponent.prototype, "subtitle");
    __decorate([
        core_1.Input()
    ], ErrorPageComponent.prototype, "desc");
    __decorate([
        core_1.Input()
    ], ErrorPageComponent.prototype, "return");
