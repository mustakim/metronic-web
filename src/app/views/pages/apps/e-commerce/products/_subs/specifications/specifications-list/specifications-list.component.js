...
var SpecificationsListComponent = /** @class */ (function () {
    ...
    __decorate([
        core_1.Input()
    ], SpecificationsListComponent.prototype, "productId$");
    __decorate([
        core_1.ViewChild(material_1.MatPaginator)
    ], SpecificationsListComponent.prototype, "paginator");
    __decorate([
        core_1.ViewChild(material_1.MatSort)
    ], SpecificationsListComponent.prototype, "sort");
    __decorate([
        core_1.ViewChild('searchInput')
    ], SpecificationsListComponent.prototype, "searchInput");
